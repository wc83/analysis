...
et1=tr1.stats.starttime + 13*60*60 + 29*60 
et2 = et1 + 180 #tr1.stats.starttime + 0*60*60 + 11*60 +30
...
t1 = UTCDateTime(2019, 1, 12, 13, 29, 0) #the format is year:day_of_the_year:month
t2 = t1 + 180
st = Stream()
...
et1=tr2.stats.starttime + 13*60*60 + 29*60 + 0
et2 = et1 + 180
tr2.plot(starttime = et1, endtime = et2 , color = 'b')

ett1=tr2.stats.starttime + 13*60*60 + 25*60 + 0
ett2 = ett1 +600
...
stre2 = read("/Users/william/Documents/Data/2019_data_collection/2019/STG8/HDF.D/UL.STG8..HDF.D.2019.012")


tr2 = stre2[0]
tr2.filter("bandpass", freqmin=0.2,freqmax=2)
et1=tr2.stats.starttime + 13*60*60 + 29*60  - 10
et2 = et1 + 180 + 10
tr2.plot(starttime = et1 + 20 , endtime = et2 , color = 'b')

ett1=tr2.stats.starttime + 13*60*60 + 27*60 + 0
ett2 = ett1 + 330
...
stre2 = read("/Users/william/Documents/Data/2019_data_collection/2019/STG2/HDF.D/UL.STG2..HDF.D.2019.012")
...
stre3 = read("/Users/william/Documents/Data/2019_data_collection/2019/STG1/EHZ.D/UL.STG1..EHZ.D.2019.012")


tr3 = stre3[0]
tr3.filter("bandpass", freqmin=0.2,freqmax=6)       
et1=tr3.stats.starttime + 13*60*60 + 29*60  - 10
et2 = et1 + 180 + 10
tr3.plot(starttime = et1 , endtime = et2 , color = 'r')
