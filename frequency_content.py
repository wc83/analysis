...
week_end = 1416787200 + 7*24*60*60 
week =0
weekly_freq=np.zeros(shape=(0,5))
aw=0
...
#np.savetxt("/Users/william/Documents/scanner/analysis/weekly_LB01_freq_v4.csv", weekly_freq,delimiter=",",header="week,dominant,central,bandwidth_50,time")
...
#np.savetxt("/Users/william/Documents/scanner/analysis/weekly_LB02_freq_v3.csv", weekly_freq,delimiter=",",header="week,dominant,central,bandwidth_50,time")

plt.figure(31)
plt.plot(weekly_freq[:,0],weekly_freq[:,1],'bx')
plt.figure(32)
plt.plot(weekly_freq[:,0],weekly_freq[:,2],'bx')
plt.figure(33)
plt.plot(weekly_freq[:,0],weekly_freq[:,3],'bx')
...
#np.savetxt("/Users/william/Documents/scanner/analysis/weekly_LB03_freq_v3.csv", weekly_freq,delimiter=",",header="week,dominant,central,bandwidth_50,time")

plt.figure(31)
plt.plot(weekly_freq[:,0],weekly_freq[:,1],'gx')
plt.figure(32)
plt.plot(weekly_freq[:,0],weekly_freq[:,2],'gx')
plt.figure(33)
plt.plot(weekly_freq[:,0],weekly_freq[:,3],'gx')
...
#np.savetxt("/Users/william/Documents/scanner/analysis/weekly_LB04_freq_v3.csv", weekly_freq,delimiter=",",header="week,dominant,central,bandwidth_50,time")

plt.figure(31)
plt.plot(weekly_freq[:,0],weekly_freq[:,1],'mx')
plt.figure(32)
plt.plot(weekly_freq[:,0],weekly_freq[:,2],'mx')
plt.figure(33)
plt.plot(weekly_freq[:,0],weekly_freq[:,3],'mx')
...
#np.savetxt("/Users/william/Documents/scanner/analysis/weekly_LB05_freq_v3.csv", weekly_freq,delimiter=",",header="week,dominant,central,bandwidth_50,time")

plt.figure(31)
plt.plot(weekly_freq[:,0],weekly_freq[:,1],'cx')
plt.figure(32)
plt.plot(weekly_freq[:,0],weekly_freq[:,2],'cx')
plt.figure(33)
plt.plot(weekly_freq[:,0],weekly_freq[:,3],'cx')
...
#np.savetxt("/Users/william/Documents/scanner/analysis/weekly_LB06_freq_v3.csv", weekly_freq,delimiter=",",header="week,dominant,central,bandwidth_50,time")
    
plt.figure(31)
plt.plot(weekly_freq[:,0],weekly_freq[:,1],'kx')
plt.legend(('LB01','LB02','LB03','LB04','LB05','LB06'))
plt.figure(32)
plt.plot(weekly_freq[:,0],weekly_freq[:,2],'kx')
plt.legend(('LB01','LB02','LB03','LB04','LB05','LB06'))
plt.figure(33)
plt.plot(weekly_freq[:,0],weekly_freq[:,3],'kx') 
plt.legend(('LB01','LB02','LB03','LB04','LB05','LB06'))       
