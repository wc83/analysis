...
for x in range(0,ran):
    if lb01[x] == 1 and  lb02[x] == 1 and lb03[x] ==1 and lb04[x] ==1 and lb05[x] ==1 :
...
dist=np.asarray([r1,r2,r3,r4,r5])
amps=np.asarray([lba1a*lb1A,lba2a*lb2A,lba3a*lb3A,lba4a*lb4A,lba5a*lb5A])#,lba3a*lb3A,lba4a*lb4A,lba5a*lb5A]) #

lx1=np.zeros(shape=(ac,1))
ly1=np.zeros(shape=(ac,1))
