...
#%%
file_exp = open('/Users/william/Documents/scanner/all_stations/All_exp_scan_3_month_30.txt','w')
file_cor2 = open('/Users/william/Documents/scanner/all_stations/All_correlated2_exp_scan_3_month_30.txt','w')
file_lb01= open('/Users/william/Documents/scanner/LB01/LB01_all_exp_scan_3_month_30.txt','w')
file_lb02= open('/Users/william/Documents/scanner/LB02/LB02_all_exp_scan_3_month_30.txt','w')
file_lb03= open('/Users/william/Documents/scanner/LB03/LB03_all_exp_scan_3_month_30.txt','w')
file_lb04= open('/Users/william/Documents/scanner/LB04/LB04_all_exp_scan_3_month_30.txt','w')
file_lb05= open('/Users/william/Documents/scanner/LB05/LB05_all_exp_scan_3_month_30.txt','w')
file_lb06= open('/Users/william/Documents/scanner/LB06/LB06_all_exp_scan_3_month_30.txt','w')
file_ls01= open('/Users/william/Documents/scanner/LS01/LS01_all_exp_scan_3_month_30.txt','w')
file_ls02= open('/Users/william/Documents/scanner/LS02/LS02_all_exp_scan_3_month_30.txt','w')
file_ls03= open('/Users/william/Documents/scanner/LS03/LS03_all_exp_scan_3_month_30.txt','w')
file_ls04= open('/Users/william/Documents/scanner/LS04/LS04_all_exp_scan_3_month_30.txt','w')
file_ls05= open('/Users/william/Documents/scanner/LS05/LS05_all_exp_scan_3_month_30.txt','w')
file_ls06= open('/Users/william/Documents/scanner/LS06/LS06_all_exp_scan_3_month_30.txt','w')
...
#%% Station LB01 scan    
    if trace1.stats.npts > 201: 
        ...
        if trace1.stats.starttime.timestamp < 1449273601.0:
            av_amp1=500
        else:
            av_amp1=60000
        ...
        for t in range(0,int(trace1.stats.npts/100), step):
            ...
            if amp > av_amp1:                
                ...
                if (0.75 < cf < 3) and (0.2 < peak < 2.75) and (0.3 < bwid < 2.5): 
    ...
    if trace2.stats.npts > 201:
        ...
        for t in range(0,int(trace2.stats.npts/100), step):
            ...
            if amp > av_amp2:  
                ...
                if (0.75 < cf2 < 4.5) and (0.4 < peak2 < 3) and (0.2 < bwid2 < 2.5):
                         #correlate between data and earthquake envelopes 
...
#                                
 ...
 #%% Station 3 scan  
    if trace3.stats.npts > 201:
        ...
        if trace3.stats.starttime.timestamp < 1457568001.0:
            av_amp3=300000
        elif 1457568001.0 <= trace3.stats.starttime.timestamp < 1466294401.0:
            av_amp3=200000
        else:
            av_amp3=80000
                    ...
                    if lastcorr > top_v:
                        ...
                        if num_active[p] > 1:
                            ...
                            if abs(rt-near) <= 20:
                                ...
                                if (lb_num_active[p] == 0) or ((lb_num_active[p] > 0) and ((Events_today[ind][2] == 1) or (Events_today[ind][3] == 1) or  (Events_today[ind][4] == 1) or (Events_today[ind][5] == 1) or (Events_today[ind][6] == 1) or (Events_today[ind][7] == 1))):
                                    near_cor,inde=find_nearest(cor_events[:,0], rt)
                                    if abs(rt-near_cor) >  60:
                                        cor_events[cor_count][0]=rt
                                        cor_events[cor_count][1]="%1d" % p
...
#%% 
print("End of Scan")
np.savetxt("/Users/william/Documents/scanner/all_stations/Explosions_per_day_3_month_30.csv", Events_per_day,delimiter=",",header="Number_of_Events,Day_number")            

col=0       
cor_events=cor_events[np.argsort(cor_events[:,col])] 
if cor_events[0,0]== 0.0:
    cor_events = np.delete(cor_events, (0), axis=0)       
np.savetxt("/Users/william/Documents/scanner/all_stations/EXP_all_coincidence_3_month_30.csv", cor_events,delimiter=",",header="Time_stamp,Day_number,Year,Day_of_year,Hour,Min,Sec,Milisec,LBO1,LB02,LB03,LB04,LB05,LB06,LSO1,LS02,LS03,LS04,LS05,LS06")
...
if len(data_stream) > 0:            
    data_stream.write('/Users/william/Documents/scanner/output_data/EXP_all_data_stream_3_month_30.mseed', format='MSEED')         
#%%
